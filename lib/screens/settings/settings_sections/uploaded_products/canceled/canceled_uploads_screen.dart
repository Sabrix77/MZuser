...
class CanceledUploadsScreen extends StatefulWidget {
  const CanceledUploadsScreen({Key? key}) : super(key: key);

  @override
  State<CanceledUploadsScreen> createState() => _CanceledUploadsScreenState();
}

class _CanceledUploadsScreenState
    extends BaseView<CanceledUploadsScreen, UploadedProductsViewModel>
