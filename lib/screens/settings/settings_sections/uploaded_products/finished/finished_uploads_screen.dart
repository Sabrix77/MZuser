...
import 'package:mzady/screens/settings/settings_sections/uploaded_products/uploaded_products_vm.dart';
import 'package:mzady/shared/constants/app_strings.dart';
import 'package:mzady/shared/constants/enums.dart';
import 'package:provider/provider.dart';


class FinishedUploadsScreen extends StatefulWidget {
  const FinishedUploadsScreen({Key? key}) : super(key: key);

  @override
  State<FinishedUploadsScreen> createState() => _FinishedUploadsScreenState();
}

class _FinishedUploadsScreenState extends BaseView<FinishedUploadsScreen,UploadedProductsViewModel>
  ...
  Widget build(BuildContext context) {
    ...
    viewModel.getProductsWitchUserUpload(userId:mainProvider.firebaseUser!.uid,auctionState: AuctionState.delivered.name);
